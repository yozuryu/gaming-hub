...
Planned work, in priority order. Not published to the site (`backlog/` is in `_config.yml` `exclude`).
...
| 2 | [Xbox integration](xbox-integration.md) | Phase 1 (pipeline) done; Phases 2–4 (hub, profile page, Activity/Completions) to do | Accent color + 100% label decisions |
