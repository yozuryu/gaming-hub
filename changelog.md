...
- Win conditions for 15 games (ending/final-boss achievements, OR logic): 14 now count as Beaten — Hi-Fi Rush, Star Ocean The Divine Force, Atomic Heart, Planet of Lana, High On Life, Titanfall 2, Tiny Tina's Wonderlands, Minecraft Dungeons, Asura's Wrath (Part III), Unravel Two, Soul Hackers 2, Hellblade, Hellblade II, Darktide (end of the Path of Trust story, chapter VI); Tales of Arise will count once finished. A Way Out has no ending achievement, so it isn't tracked
...
- Backlog: pipeline review (`pipeline-improvements.md`) — urgent data-integrity fixes (Steam errors wrongly marking games as having no achievements, RA writing partial activity on a failed fetch, full refresh dropping failed games), commit-noise reduction, schedule reliability, and cleanup
